...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/admin/good" method="get" >
            ...
            &nbsp;&nbsp;------&nbsp;&nbsp;
            <input type="text" name="dsprice"  placeholder="最高价格" value="{{$request->dsprice or '' }}" autocomplete="off" class="layui-input">
    ...
    <table class="layui-table">
        ...
        @foreach($good as $v)
            ...
            <tr>
                ...
                <td class="td-manage">
                    <a onclick="member_stop(this,'{{ $v->gid }}')" value="{{$v->status}}" href="javascript:;" status="{{$v->status}}"
                       title="@if($v->status==0) 下架 @else 上架 @endif">
