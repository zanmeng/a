    ...
    <form enctype="multipart/form-data" id="art_form" class="layui-form" action="{{ url('admin/user/doauth') }}" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" value="{{ $user->userName }}" disabled="" name="userName" required="" lay-verify=""
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block">
                @foreach($role as $v)
                    {{--//  如果当前角色拥有正在遍历的权限--}}
                    @if(in_array($v->roleId,$own_roleids))
                        <input type="checkbox" checked value="{{ $v->roleId }}" name="roleId[]" lay-skin="primary" title="{{ $v->role_name }}" >
                    @else
                        <input type="checkbox"  value="{{ $v->roleId }}" name="roleId[]" lay-skin="primary" title="{{ $v->role_name }}" >
                    @endif
